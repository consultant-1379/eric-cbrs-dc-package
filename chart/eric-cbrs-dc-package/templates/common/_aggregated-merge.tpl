...
{{- define "eric-cbrs-dc-package.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-cbrs-dc-package.mergeAnnotations" -}}
  {{- include "eric-cbrs-dc-package.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-cbrs-dc-package.mergeLabels" -}}
  {{- include "eric-cbrs-dc-package.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}

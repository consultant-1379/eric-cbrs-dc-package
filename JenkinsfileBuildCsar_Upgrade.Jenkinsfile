...
pipeline {
    ...
    parameters {
        ...
        string(name: 'NAMESPACE', description: '(Optional) Provide namespace for upgrade', defaultValue: 'cbrs')
        string(name: 'CSAR_VERSION', defaultValue: 'drop', description: '(Optional) Leave empty for latest drop version. CSAR version e.g.: 0.108.0-9, drop, release, build')        
    }
    stages {
